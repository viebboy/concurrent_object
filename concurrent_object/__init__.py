...
This is part of the concurrent_object project (github.com/viebboy/concurrent_object)
...
try:
    ...
    print('concurrent_object package WARNING: (re)install the dependencies in requirements.txt')
    has_dep = False

# root dir is for user configuration
STATUS_FILE = os.path.join(os.path.expanduser('~'), '.concurrent_object.status')
